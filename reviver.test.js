...
export default function test(assert) {
	try {
		...
		assert.equal(revived_city_1.streets[0].population, 100, 'In non strict mode, even properties which have not been declared are copied: population for first street is 100');
